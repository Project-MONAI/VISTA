...
from vista3d.modeling import VISTA3D2, Point_Mapping_SAM, Class_Mapping_Classify, SegResNetDS2
...
class VISTA3D2_eval_only(VISTA3D2):
    ...
    def forward(self, input_images,       
        ...
        **kwargs):
        out, out_auto = self.image_encoder(input_images, with_point=True, with_label=True)
        input_images = None
        # force releasing memories that set to None
        torch.cuda.empty_cache()
