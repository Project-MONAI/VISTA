...
USE_SV_GT_LIST=['TotalSegmentatorV2', 'Covid19', 'NLST', 'LIDC', 'StonyBrook-CT', 'TCIA_Colon']          
...
def sample_points_patch_val(labels, patch_coords, label_set, use_center=True, mapped_label_set=None, max_ppoint=1, max_npoint=0, **kwargs):
...
def generate_prompt_pairs(labels, label_set=None, max_prompt=None, max_foreprompt=None, max_backprompt=1, max_point=20, 
                          include_background=False, drop_label_prob=0.2, drop_point_prob=0.2, point_sampler=None):
