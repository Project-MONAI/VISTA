...
import numpy as np
from .workflow_utils import SPECIAL_INDEX, ENABLE_SPECIAL, get_point_label
from .trans_utils import erode3d, dilate3d
...
class Point_sampler():
    ...
    """
    def __init__(self, label, label_sv, map_shift=512, offset=10, vrange=[0.6, 0.7, 0.8, 0.9],):
        self.label = label
